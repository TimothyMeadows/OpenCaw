...
description: Maintain, generate, or validate the host STYLE.md contract from OpenCaw art-style and art-pipeline templates. Use when visual work must preserve project art direction and its CLOUD, LOCAL, CSS3, or CODE production path.
---
